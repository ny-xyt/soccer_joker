...
void PrintGreeting() {
    cout << "TD3drobo 3D Simulation Team Base Code\n";
...
//map<string, string> namedParams_t0;
//map<string, string> namedParams_t1;
//map<string, string> namedParams_t4;
...
//             if (agentBodyType == 0) {
//                 Load_param_t0();
//                 namedParams = namedParams_t0;
//             } else if (agentBodyType == 1) {
//                 Load_param_t1();
//                 namedParams = namedParams_t1;
//             } else if (agentBodyType == 4) {
//                 Load_param_t4();
//                 namedParams = namedParams_t4;
//             }
