...
//****Apollo3D****  ADDED SKILLTYPES
	string2enum["SKILL_KICK_LOW_LEFT_LEG"] = SKILL_KICK_LOW_LEFT_LEG;
    enum2String[SKILL_KICK_LOW_LEFT_LEG] = "SKILL_KICK_LOW_LEFT_LEG";

	string2enum["SKILL_KICK_LOW_RIGHT_LEG"] = SKILL_KICK_LOW_RIGHT_LEG;
    enum2String[SKILL_KICK_LOW_RIGHT_LEG] = "SKILL_KICK_LOW_RIGHT_LEG";


    string2enum["SKILL_TONGDA_KICK_12M_LEFT_LEG"] = SKILL_TONGDA_KICK_12M_LEFT_LEG;
    enum2String[SKILL_TONGDA_KICK_12M_LEFT_LEG] = "SKILL_TONGDA_KICK_12M_LEFT_LEG";
    
    string2enum["SKILL_TONGDA_KICK_12M_RIGHT_LEG"] = SKILL_TONGDA_KICK_12M_RIGHT_LEG;
    enum2String[SKILL_TONGDA_KICK_12M_RIGHT_LEG] = "SKILL_TONGDA_KICK_12M_RIGHT_LEG";
...
// INVERSE KINEMATICS KICKS
    ...
    // KICK SHORT
    string2enum["SKILL_KICK_SHORT_LEFT_LEG"] = SKILL_KICK_SHORT_LEFT_LEG;
    enum2String[SKILL_KICK_SHORT_LEFT_LEG] = "SKILL_KICK_SHORT_LEFT_LEG";

    string2enum["SKILL_KICK_SHORT_RIGHT_LEG"] = SKILL_KICK_SHORT_RIGHT_LEG;
    enum2String[SKILL_KICK_SHORT_RIGHT_LEG] = "SKILL_KICK_SHORT_RIGHT_LEG";
...
//****Apollp3D****
    string2enum["SKILL_BLOCK_LEFT"]=SKILL_BLOCK_LEFT;
    enum2String[SKILL_BLOCK_LEFT]="SKILL_BLOCK_LEFT";

    string2enum["SKILL_BLOCK_RIGHT"]=SKILL_BLOCK_RIGHT;
    enum2String[SKILL_BLOCK_RIGHT]="SKILL_BLOCK_RIGHT";

    string2enum["SKILL_BLOCK_SIDE_LEFT"]=SKILL_BLOCK_SIDE_LEFT;
    enum2String[SKILL_BLOCK_SIDE_LEFT]="SKILL_BLOCK_SIDE_LEFT";

    string2enum["SKILL_BLOCK_SIDE_RIGHT"]=SKILL_BLOCK_SIDE_RIGHT;
    enum2String[SKILL_BLOCK_SIDE_RIGHT]="SKILL_BLOCK_SIDE_RIGHT";

    string2enum["FALL_RIGHT"] = FALL_RIGHT;
    enum2String[FALL_RIGHT] = "FALL_RIGHT";
    
    string2enum["FALL_LEFT"] = FALL_LEFT;
    enum2String[FALL_LEFT] = "FALL_LEFT";
    
    string2enum["SKILL_SHOOT_UT_LEFT_LEG"] = SKILL_SHOOT_UT_LEFT_LEG;
    enum2String[SKILL_SHOOT_UT_LEFT_LEG] = "SKILL_SHOOT_UT_LEFT_LEG";

    string2enum["SKILL_SHOOT_UT_RIGHT_LEG"] = SKILL_SHOOT_UT_RIGHT_LEG;
    enum2String[SKILL_SHOOT_UT_RIGHT_LEG] = "SKILL_SHOOT_UT_RIGHT_LEG";
    
    string2enum["SKILL_KICK_8M_LEFT_LEG"] = SKILL_KICK_8M_LEFT_LEG;
    enum2String[SKILL_KICK_8M_LEFT_LEG] = "SKILL_KICK_8M_LEFT_LEG";
    
    
    string2enum["SKILL_KICK_8M_RIGHT_LEG"] = SKILL_KICK_8M_RIGHT_LEG;
    enum2String[SKILL_KICK_8M_RIGHT_LEG] = "SKILL_KICK_8M_RIGHT_LEG";
...
bool isKickSHORTSkill(SkillType skill)
{
    string skillStr = EnumParser<SkillType>::getStringFromEnum( skill );
    return skillStr.find("KICK_SHORT") != string::npos;
}
