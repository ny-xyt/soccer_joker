...
//****Apollo3D****
    SKILL_KICK_LOW_LEFT_LEG,
    SKILL_KICK_LOW_RIGHT_LEG,

    SKILL_TONGDA_KICK_12M_LEFT_LEG,
    SKILL_TONGDA_KICK_12M_RIGHT_LEG,
    

    SKILL_KICK_IK_0_LEFT_LEG,
    SKILL_KICK_IK_0_RIGHT_LEG,

    SKILL_KICK_SHORT_LEFT_LEG,
    SKILL_KICK_SHORT_RIGHT_LEG,

    SKILL_BLOCK_LEFT,
    SKILL_BLOCK_RIGHT,

    SKILL_BLOCK_SIDE_LEFT,
    SKILL_BLOCK_SIDE_RIGHT,
//*************
    FALL_RIGHT,
    FALL_LEFT,
    ...
    SKILL_SHOOT_UT_LEFT_LEG,
    SKILL_SHOOT_UT_RIGHT_LEG,
    
    SKILL_KICK_8M_LEFT_LEG,
    SKILL_KICK_8M_RIGHT_LEG,
...
//****Apollo3D****
#define KICK_FORWARD     1    //13m
#define KICK_LOW         2   //12m
#define TONGDA_KICK_12M         3    //12m  
#define KICK_IK          4  //4.5m
#define KICK_SHORT       5  //5.5m
#define SHOOT_UT 6  //13m
#define KICK_8M 7  //8m

// Number of agents on the team
#define NUM_AGENTS 11
#define AGENTS_NUM_ARRAY 12
...
{
	FM_Play_On,
	/** ball went across our end line by opp, To playon: drop to the squre cornor*/
	FM_Our_Goal,
	FM_Opp_Goal,
	/** opp kick ball went across opp end line*/
	FM_Our_Corner,
	/** our kick ball went across our end line*/
	FM_Opp_Corner,
	FM_Our_Kick_In,
	FM_Kick_Off,
	FM_Opp_Kick_In,
